...
export function getAirportContactNumber(airport?: string): string {
    const a = String(airport || "").toLowerCase();
    if (a.includes("bristol")) return "0117 000 0000";
    if (a.includes("heathrow")) return "07426151798";
    if (a.includes("gatwick")) return "07754647575";
    return "0117 000 0000";
}
