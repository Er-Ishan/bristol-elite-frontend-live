...
const PrivatePolicy = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Privacy Policy | Heathrow Elite Parking</title>
        <meta name="description" content="Privacy policy of Heathrow Elite Parking. How we collect, use and protect your data for airport parking and park and ride services." />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href={`${BASE_URL}/privacypolicy`} />
        <meta property="og:title" content="Privacy Policy | Heathrow Elite Parking" />
