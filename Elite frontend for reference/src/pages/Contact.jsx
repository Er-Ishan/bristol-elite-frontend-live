...
const Contact = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Contact Us | Heathrow Elite Parking</title>
        <meta name="description" content="Contact Heathrow Elite Parking for bookings, enquiries and support. Get in touch for Heathrow airport park and ride and parking assistance." />
        <meta name="keywords" content="contact Heathrow Elite Parking, Heathrow parking contact, airport parking enquiry" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href={`${BASE_URL}/contact`} />
        <meta property="og:title" content="Contact Us | Heathrow Elite Parking" />
        <meta property="og:description" content="Contact Heathrow Elite Parking for bookings and enquiries." />
            ...
            <div className="col-lg-5">
              <div className="contact-info-card">
                ...
                <div className="info-box">
                  <h5>Contact Info</h5>
                  <p>
                    Email: support@heathroweliteparking.co.uk<br />
                    Phone: 0700 000 2233
                  </p>
                </div>
