                                    ...
                                    {[
                                        ...
                                        <li className="nav-item flex-fill text-center" key={key}>
                                            <button
                                                ...
                                                style={{
                                                    backgroundColor: activeTab === key ? "#005c25" : "#fff",
                                                    color: activeTab === key ? "#fff" : "#005c25",
                                                    borderRadius: "8px",
                                                    padding: "12px 0",
                            ...
                            <div className="col-lg-4">
                                <div className="card h-100 border-2">
                                    <div className="card-body p-4 d-flex flex-column text-center">
                                        ...
                                        {/* Title */}
                                        {/* <h4 className="fw-bold mb-1" style={{ color: "#005c25" }}>
                                        ...
                                        <ul className="list-unstyled text-start mb-4">
                                            ...
                                            <li className="d-flex align-items-start gap-2 mb-2">
                                                <IoIosCheckmarkCircle className="mt-1" size={18} style={{ color: "#005c25" }} />
