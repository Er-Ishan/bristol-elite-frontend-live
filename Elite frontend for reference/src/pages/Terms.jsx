...
const Terms = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Terms &amp; Conditions | Heathrow Elite Parking</title>
        <meta name="description" content="Terms and conditions for using Heathrow Elite Parking. Read our booking and service terms for Heathrow airport park and ride." />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href={`${BASE_URL}/termsandconditions`} />
        <meta property="og:title" content="Terms &amp; Conditions | Heathrow Elite Parking" />
        ...
        <div className="container my-5">
          <div className="policy-wrapper mx-auto p-4 p-md-5">
            ...
            <p className="policy-intro">
              ...
              <strong> https://heathroweliteparking.co.uk/
