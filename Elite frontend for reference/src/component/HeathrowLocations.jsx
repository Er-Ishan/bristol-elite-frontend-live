      ...
      <div className="container py-5">
        ...
        <div className="text-center mb-5">
          <h2 className="locations-title fw-bold">
            Heathrow & Gatwick Airport Parking You Can Rely On
          </h2>
          <p className="locations-subtitle mt-3 mx-auto">
            Close to Heathrow & Gatewick, Gregg Maurice Parking is a trusted choice for
        ...
        <div className="row align-items-center g-4">
          ...
          <div className="col-lg-4">
            <div className="terminal-box">
              ...
              <div className="terminal-item">
                <FaParking />
                <span>Heathrow Terminal 3</span>
              </div>

              <div className="terminal-item">
                <FaParking />
                <span>Heathrow Terminal 4</span>
              </div>
          ...
          <div className="col-lg-4">
            <div className="terminal-box">
              ...
              <div className="terminal-item">
                <FaParking />
                <span>Gatwick airport parking</span>
              </div>

              <div className="terminal-item">
                <FaParking />
                <span>Gatwick long stay parking</span>
              </div>

              <div className="terminal-item">
                <FaParking />
                <span>Gatwick south terminal parking</span>
              </div>

              <div className="terminal-item">
                <FaParking />
                <span>Gatwick north terminal parking</span>
              </div>
