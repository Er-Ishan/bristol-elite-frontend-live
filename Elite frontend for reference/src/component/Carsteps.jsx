      ...
      <div className="container py-5">
        ...
        <div className="text-center mx-auto pb-5" style={{ maxWidth: 900 }}>
          <h2 className="fw-bold mb-3 carsteps-title">
            Heathrow <span className="highlight-text">Park & Ride</span> Made Simple
          </h2>
        </div>
        ...
        <div className="row g-4 justify-content-center">
          ...
          <StepCard number="01" text="Book Heathrow Parking Online" />
          <StepCard number="02" text="Drive to Our Secure Car Park" />
          <StepCard number="03" text="Enjoy Your Trip with Peace of Mind" />
