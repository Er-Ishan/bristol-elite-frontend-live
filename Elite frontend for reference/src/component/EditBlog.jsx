...
const EditBlog = () => {
    ...
    // useEffect(() => {
    //     if (!editor || !blogData) return;

    //     editor.commands.setContent(blogData.content || "", false);
    // }, [editor, blogData]);
    ...
    if (!blogData) {
        return <div style={{ padding: "50px" }}>Loading blog...</div>;
    }
            ...
            <div className="blog-container">
                <div className="blog-card">
                    ...
                    <div className="blog-header">
                        <div>
                            <h2 style={{ color: "#005c25" }}>Edit Blog</h2>
                        </div>
                        <button
                            className="back-btn"
                        ...
                        <div className="section">
                            ...
                            <div className="row">
                                <div className="form-group">
                                    ...
                                    {blogData?.image && (
                                        <img src={blogData.image} alt="preview" width="120" style={{ marginTop: "10px" }} />
                                    )}
                                </div>
