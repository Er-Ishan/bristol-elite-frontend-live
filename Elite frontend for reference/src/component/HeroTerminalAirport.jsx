...
export default function Hero() {
    ...
    return (
        <section id="heroterminalairport">
                                        ...
                                        >
                                            <div className="text-start w-100">
                                                ...
                                                <h2 className="fw-bold mb-3" style={{ color: "#005c25" }}>
                                                    Heathrow Airport Parking Secure and Affordable
                                                </h2>
                                                ...
                                                >
                                                    Flying from Heathrow Airport can feel exciting. It can also feel… slightly chaotic. 
                                                ...
                                                >
                                                    Anyone who has taken an early flight is familiar with the procedure. Bags packed. Passport checked five times. Taxi late. Parking full. Stress building. From the moment you get to the place of departure, you begin to panic about immigration lines and departure times. Right away, you find yourself circling car parks, confused about where to place your car. Unexpectedly, parking tends to be the most aggravating aspect. Not fun. 
